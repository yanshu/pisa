...
def get_event_rates_pid(reco_events,pid_dict=None,**kwargs):
    '''
    ...
    pid_service = PIDService(pid_dict,ebins,czbins)
...
if __name__ == '__main__':
    ...
    event_rate_pid = get_event_rates_pid(reco_events,pid_dict)
