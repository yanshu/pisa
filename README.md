...
A minimizer attempts to match the "data" distribution (with what is called a template, generated by an analysis pipeline or the combination of outputs from multiple pipelines) as closely as possible by varying the parameters.
