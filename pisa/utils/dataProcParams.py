      ...
      "<lower-case detector name>": {
        ...
        "<lower-case processing version>": {
          ...
          "field_map": {
            ...
            "event": "<HDF5 path to corresponding node>",
            "nu_code": "<HDF5 path to corresponding node>",
            "true_x": "<HDF5 path to corresponding node>",
            "true_y": "<HDF5 path to corresponding node>",
            "true_z": "<HDF5 path to corresponding node>",
            "true_azimuth": "<HDF5 path to corresponding node>",
            "reco_x": "<HDF5 path to corresponding node>",
            "reco_y": "<HDF5 path to corresponding node>",
            "reco_z": "<HDF5 path to corresponding node>",
            "reco_azimuth": "<HDF5 path to corresponding node>",
            "reco_trck_len": "<HDF5 path to corresponding node>",
            ...
            "weight_ocelot": "<HDF5 path to corresponding node>",
        ...
        try:
            ...
            for name, path in field_map.items():
                ...
                if key_name  in h5.keys():
                    ...
                    print name, " can't be written, because ", key_name, " not in hdf5 file"
        finally:
