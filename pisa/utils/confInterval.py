...
class MLConfInterval:
    def __init__(self, x, y, epsilon=1e-10):
        ...
        assert (np.abs(self.total_area-trapz_total_area) < self.epsilon), 'Total areas do not match within the specified precision, epsilon='+str(self.epsilon)
    ...
    def findCI_lin(self, conf, maxiter=100):
        ...
        y, r = sp.optimize.brentq(self.area, 1e-5, self.max_y, args=(target_area,),
