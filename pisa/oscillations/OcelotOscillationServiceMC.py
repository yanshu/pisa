...
class OcelotOscillationServiceMC(OscillationServiceBase):
    """
    ...
    def fill_osc_prob(self, ecen, czcen, event_by_event=True,
        ...
        for nu in ['nue','numu','nue_bar','numu_bar']:
            ...
            osc_prob_dict[nu+'_maps'] = {'nue'+isbar: [],
                                         'numu'+isbar: [],
                                         'nutau'+isbar: []}
       ...
       #print "osc_prob_dict['numu_maps'] = ", osc_prob_dict['numu_maps']['nue']
       #print "osc_prob_dict['numu_maps'] = ", osc_prob_dict['numu_maps']['nue']
