...
for run_num in [50,60,61,64,65,70,71,72]:
    ...
    outfilename = '%s/1X%i_weighted_aeff_joined_nu_nubar_%i_percent_down.hdf5'% (out_dir,run_num,int(frac*100))
    ...
    if frac !=1:
        ...
        print "len(downgoing nc) = ", len_data
    ...
    for flavor in ['nutau','numu','nue']:
        ...
        if frac !=1:
            ...
            print "len( downgoing ", flavor , ") = ",  len_data
