...
if __name__ == '__main__':
    ...
    if args.theta23_range is not None:
        ...
        t23_range_lo = (30.0, 60.0)*ureg.deg
        t23_range_uo = (30.0, 60.0)*ureg.deg
    ...
    for lt, t23 in product(args.livetime, args.theta23):
        ...
        for hypo_param_selection in hypo_param_selections:
            one_fit_dict = {'wrong octant': {}, 'true octant': {}}
            ...
            logging.info("Searching for best match to"
            ...
            bf_wo, _ = analysis.fit_hypo(data_dist=data_dist, hypo_maker=hypo_maker,
            ...
            one_fit_dict['true octant'] = deepcopy(bf_to)
