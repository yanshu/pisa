...
class Maps_nutau_cls():
    ...
    def apply_domeff_holeice(self,template, params, channel):
        ...
        domeff_holeice_slope_file = find_resource(params['domeff_holeice_slope_file'])
        if (self.domeff_holeice_slope_file != domeff_holeice_slope_file) or self.slope == None:
            self.slope = from_json(domeff_holeice_slope_file)
            self.domeff_holeice_slope_file = domeff_holeice_slope_file
        ...
        if isinstance(template,list) and len(template)==2:
            ...
            for flav in flavs:
                ...
                slope_DE_up = self.slope['slopes']['data_tau']['k_DomEff'][flav]['up']
                slope_DE_down = self.slope['slopes']['data_tau']['k_DomEff'][flav]['down']
                slope_HI_up = self.slope['slopes']['data_tau']['k_HoleIce'][flav]['up']
                slope_HI_down = self.slope['slopes']['data_tau']['k_HoleIce'][flav]['down']
            ...
            for flav in flavs:
                output_map[flav] = {}
                slope_DE = self.slope['slopes']['data_tau']['k_DomEff'][flav][direction]
                slope_HI = self.slope['slopes']['data_tau']['k_HoleIce'][flav][direction]
    ...
    def apply_reco_precisions(self,template, params, channel):
        ...
        reco_prcs_coeff_file = find_resource(params['reco_prcs_coeff_file'])
        if (self.reco_prcs_coeff_file != reco_prcs_coeff_file) or self.cubic_coeff == None:
            self.cubic_coeff = from_json(reco_prcs_coeff_file)
            self.reco_prcs_coeff_file = reco_prcs_coeff_file
        ...
        if isinstance(template,list) and len(template)==2:
            ...
            for flav in flavs:
                ...
                for direction in ['up', 'down']:
                    cubic_coeff_e_precision_up = self.cubic_coeff['coeffs']['data_tau']['e_reco_precision_up'][flav][direction]
                    cubic_coeff_e_precision_down = self.cubic_coeff['coeffs']['data_tau']['e_reco_precision_down'][flav][direction]
                    cubic_coeff_cz_precision_up = self.cubic_coeff['coeffs']['data_tau']['cz_reco_precision_up'][flav][direction]
                    cubic_coeff_cz_precision_down = self.cubic_coeff['coeffs']['data_tau']['cz_reco_precision_down'][flav][direction]
