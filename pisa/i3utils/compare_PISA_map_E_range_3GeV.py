...
settings file. ''')
    ...
    ##### Get Maps from using Larger Energy range (5.6 to 56 GeV range)  #####
    ...
    smallerRange_up_template_settings['binning']['ebins'] = template_settings['binning']['ebins'][2:]
    ...
    smallerRange_down_template_settings['binning']['ebins'] = template_settings['binning']['ebins'][2:]
