...
class prop_grid(Stage):
    ...
    def __init__(self, params, input_binning, output_binning,
        ...
        self._grid_detector_depth = self.params.detector_depth.value.to('km')
    ...
    def initialize_kernel(self,detector_depth):
        ...
        self.grid_prop  = GridPropagator(
            find_resource(self._grid_earth_model), self.FTYPE(self.czcen_fine),
            self.FTYPE(self._grid_detector_depth))
