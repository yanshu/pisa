...
class vbwkde(Stage):
    ...
    @staticmethod
    def compute_raw_kdes(e_true, cz_true, e_reco, cz_reco, flav, int_type,
                         ebins, czbins, make_plots=False):
        ...
        for ebin_n in range(n_ebins):
            ...
            cz_interp = interpolate.interp1d(
                x=cz_mesh, y=cz_pdf, kind='linear',
                copy=True, bounds_error=True, fill_value=np.nan
            )

            raw_kde_info[(ebin_min, ebin_mid, ebin_max)] = dict(
...
#            kde_area2 = float(n_in_bin)
#            print 'E: kde_area:', kde_area
#            print 'E: kde_area2:', kde_area2
#
...
#                x=enu_mesh_scaled, y=enu_pdf, kind='linear',
#                copy=True, bounds_error=True, fill_value=np.nan
#            )
...
#
#            # Re-normalize pdf
#            #scaled_area = np.trapz(x=enu_mesh, y=enu_pdf_scaled)
#            scaled_area = e_factor
#            #print 'E: scaled_area:', scaled_area
#            #print 'E: scaled_area2:', scaled_area2
#
#            enu_pdf_scaled /= scaled_area
#
...
#            # Create linear interpolator for the PDF
#            interp = interpolate.interp1d(
#                x=offset_enu_mesh, y=offset_enu_pdf, kind='linear',
#                copy=True, bounds_error=True, fill_value=np.nan
#            )
#
...
#
#            interp = interpolate.interp1d(
#                x=cz_mesh_scaled, y=cz_pdf, kind='linear',
#                copy=True, bounds_error=True, fill_value=np.nan
#            )
...
#
#            # TODO: should scaled area care about wrapping behavior of 
#            # coszen, or should it just be the same as cz_factor?
#
#            # Re-normalize pdf
#            #scaled_area2 = np.trapz(x=cz_mesh, y=cz_pdf_scaled)
#            scaled_area = cz_factor
#            #print 'CZ: scaled_area:', scaled_area
#            #print 'CZ: scaled_area2:', scaled_area2
#            cz_pdf_scaled /= scaled_area
#
...
#                interp = interpolate.interp1d(
#                    x=offset_cz_mesh, y=cz_pdf_scaled, kind='linear',
...
#        return kernel4d
    ...
    def _compute_nominal_transforms(self):
        ...
        self.raw_kde_info = OrderedDict()
        nominal_transforms = []
        for xform_flavints in self.transform_groups:
            logging.debug("Working on %s reco kernels" %xform_flavints)

            # TODO: This is due to repetition of flavors/interaction types in
            # events files that are "grouped" together. Someday that will
