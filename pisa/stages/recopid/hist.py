...
class hist(Stage):
    ...
    def __init__(self, params, particles, input_names, transform_groups,
        ...
        # `params` argument.
        expected_params = (
            'recopid_events', 'recopid_weights_name',
    ...
    def _compute_transforms(self):
        ...
        **UN**weighted. This is probably quite wrong...
        ...
        self.load_events(self.params.recopid_events)
        ...
        for xform_flavints in self.transform_groups:
            ...
            # True (input) + reco+PID (output) (2N+N_pid-dimensional) histogram
            # is the basis for the transformation
            reco_kernel = tmp_events.histogram(
                kinds=xform_flavints,
                binning=output_binning,
                weights_col=self.params.recopid_weights_name.value
            )

            # 2 input dimensions true-E,reco-E)
            # -> 3 output dimensions (reco-E,reco-CZ,PID)
