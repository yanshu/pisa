...
class honda(Stage):
    ...
    Both 2D and 3D tables can be loaded.
    The specifics of this are explained below the respective load_table function.
    ...
    Output Names
    ------------
    The `outputs` container generated by this service will be objects with the following `name` attributes:
    ...
    * honda-2011-frj-mountain-solmin-aa.d
    ...
    To choose between these, set 'flux_mode' in your pipeline settings file to either 'bisplrep' or 'integral-preserving'.
    ...
    .. [2] M. Honda, M. Sajjad Athar, T. Kajita, K. Kasahara, S. Midorikawa, "Atmospheric neutrino flux calculation using the NRLMSISE00 atmospheric model", Phys. Rev. D92, 023004 (2015), arXiv:1502.03916.
