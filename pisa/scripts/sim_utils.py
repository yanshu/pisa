...
# NOTE: Commenting out the following as it is now redundant; remove when
# verified that it is no longer called anywhere.
#
# Use
#   pisa/aeff/AeffServiceMC.AeffServiceMC.get_aeff_with_error()
# method instead.
